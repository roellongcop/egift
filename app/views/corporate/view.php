...
<div class="profile-view">
   ...
   <h2>
        ...
        <?php if($model->user->status == 0 || $model->user->status == 1): ?>
            <?= Html::a('Add to Block list', ['corporate/add-to-blocklist', 'user_id' => $model->user_id], [
                'class' => 'pull-right btn btn-danger'
            ]) ?>
        <?php else: ?>
            <?= Html::a('Authorized', ['corporate/set-to-authorized', 'user_id' => $model->user_id], [
                'class' => 'pull-right btn btn-primary'
            ]) ?>

            <?= Html::a('Un-Authorized', ['corporate/set-to-unauthorized', 'user_id' => $model->user_id], [
